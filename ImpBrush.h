...
public:
	...
	virtual void AlterBegin( const Point source, const Point target ) = 0;
	virtual void AlterMove( const Point source, const Point target ) = 0;
	virtual void AlterEnd( const Point source, const Point target ) = 0;
